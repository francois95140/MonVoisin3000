...
const Messages: React.FC = () => {
  ...
  const [conversations] = useState([
    ...
    },
    {
      ...
      lastMessage: 'Merci pour ton aide avec le d�m�nagement !',
      time: '12:15',
      unread: 0,
      online: false
    },
        ...
        {conversations.length === 0 && (
          <GlassCard className="text-center py-12">
            ...
            <p className="text-white/60 mb-6">
              Commencez � discuter avec vos voisins !
            </p>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-yellow-200/80 text-xs mt-1">
                Utilisez les messages pour organiser des �v�nements, �changer des services ou simplement faire connaissance avec vos voisins !
              </p>
            </div>
          </div>
        </GlassCard>
